...
with open(os.path.join(os.path.abspath(os.path.dirname(__file__)), 'credentials.json')) as file:
...
def get_access_token(service, username, password):
    """
...
def get_args():
    ...
    parser.add_argument(
        ...
        default=False)
    parser.add_argument(
        '-d', '--debug', help='Debug Mode', action='store_true', default=True)
